        ...
        <nav className="navbar">
          <div className="container nav-inner">
            <Link to="/" className="logo">
              <svg className="logo-icon" aria-label="FluentEdge Logo" role="img" xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 82 100" fill="none">
